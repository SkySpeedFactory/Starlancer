...
public class PoliceAttack : State<PoliceAIBehaviour>
{
    ...
    public PoliceAttack(PoliceAIBehaviour owner) : base(owner)
    {

    }

    public void InitializeState(StateMachine<PoliceAIBehaviour> stateMachine, State<PoliceAIBehaviour> stateMove)
    {
    ...
    public override void OnEnter()
    {
        ...
        if (owner.AiStats.GetCanCheckPlayerInventory())
        {
            owner.SetHasCheckedPlayer(true);
        }
    ...
    public override void OnExit()
    {
        if (owner.AiStats.GetCanCheckPlayerInventory())
        {
            owner.SetHasCheckedPlayer(AIManager.Instance.GetIsPlayerInventoryChecked());
        }
